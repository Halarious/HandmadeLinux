...
DrawRectangleHopefullyQuickly(loaded_bitmap *Buffer, v2 Origin, v2 XAxis, v2 YAxis, v4 Color,
                              loaded_bitmap *Texture, r32 PixelsToMeters)
{
    ...
    v2 NxAxis = V2MulS((YAxisLength / XAxisLength), XAxis);
    v2 NyAxis = V2MulS((XAxisLength / YAxisLength), YAxis);
    ...
    // TODO(casey): IMPORTANT(casey): STOP DOING THIS ONCE WE HAVE REAL ROW LOADING
    ...
    r32 OriginZ = 0.0f;
    r32 OriginY = (V2Add(V2Add(Origin, V2MulS(0.5f,XAxis)), V2MulS(0.5f,YAxis))).y;
    r32 FixedCastY = InvHeightMax*OriginY;
...
#define M(a, i) ((float *)&(a))[i]
                ...
                ++I)
            {
                ...
                if(ShouldFill[I])
                {
                    ...
                    u32 SampleB = *(u32 *)(TexelPtr + sizeof(u32));
                    u32 SampleC = *(u32 *)(TexelPtr + Texture->Pitch);
                    u32 SampleD = *(u32 *)(TexelPtr + Texture->Pitch + sizeof(u32));
